...
def init_pins():
  ...
  try:
    ...
    print "Ignoring GPIO init for relay_board"
    pass
...
#                    print 'relay switched off', i + 1, "pin", relay_pins[i]  #  for testing ############
                ...
                print "Problem controlling relays. Using simulated relays instead.", e
                pass
            except Exception, e:
                print "Problem controlling relays", e, relay_pins[i]
                pass
